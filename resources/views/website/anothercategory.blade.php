...
@section('title', $anotherCategory_name->name)
@push('website-css')
    <style>
        .range-slider {
            width: 100%;
            ...
            <div class="custom-container">
                <nav class="border pt-2 px-3 my-3 bg-light d-flex vertical-align" style="" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        ...
                        <li class="breadcrumb-item active fw-bolder" aria-current="page">{{$anotherCategory_name->name}}</li>
                    </ol>
                                                    ...
                                                    <ul id="menu_item{{ $item->id }}" class="mb-0 collapse"
                                                        ...
                                                        @foreach ($item->subcategory as $subcate)
                                                            <li> <a
                                                                ...
                                                                <ul id="menu_item{{ $item->id }}" class="mb-0 collapse"
                                                                    data-bs-parent="#nav_accordion">
                                                                    @foreach ($subcate->subSubCategory as $subsub)
                                                                        <li> <a
                                                                                href="{{ route('sub.subcategory.product', $subsub->slug) }}">{{ $subsub->name }}
