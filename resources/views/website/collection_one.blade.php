...
@section('title', $content->is_collection_title_1)
@push('website-css')
    <style>
        .range-slider {
            width: 100%;
    ...
    <form action="" id="filter">
        <div id="filter-input">
            <div class="custom-container">
                <nav class="border pt-2 px-3 my-3 bg-light d-flex" style="" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2">
                        <li class="breadcrumb-item fw-bold"><a href="{{ route('home.index') }}">Home</a></li>
                        <li class="breadcrumb-item active fw-bolder" aria-current="page">{{ $content->is_collection_title_1 }}</li>
                    </ol>
                                                ...
                                                <div class="col-md-3 col-6">
                                                    <div class="product-single">
                                                        ...
                                                        <div class="product-content mt-2">
                                                            ...
                                                            <p> <span class="tk-font">৳</span> {{ $item->price }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    success: function(res) {
                        ...
                        $.each(res, function(key, value) {
                            ...
                            data +=
                                ...
                                value.id + ')"></i>'
                            data += '</div>'
                            data += '<div class="product-content mt-2">'
                            data += '<a href="' + urlDetails +
                                '"><h5 class="m-0 product-name">' + value.name +
                                '</h5></a>'
                            data += '<p> <span class="tk-font">৳</span> ' + value
                                .price + '</p>'
                            data += '</div></div></div>'
                        })
                        $('#data-row').html(data);
