                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <strong><label>Tailoring Charge</label> <span class="my-label">:</span>
                                                </strong>
                                            </div>

                                            <div class="col-md-8">
                                                <input type="number" name="tailoring_charge" id="is_tailoring"
                                                    value="{{ old('tailoring_charge') }}" disabled placeholder="Tailoring Charge" 
                                            ...
                                            <div class="col-md-3 mt-1">
                                                <img class="form-controlo img-thumbnail" src="#" id="previewImage3"
                                                    style="width: 100px;height: 80px; background: #3f4a49;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4 mt-2">
                                                <strong><label>Similar Product</label> <span
                                                        class="my-label">:</span> </strong>
                                            </div>

                                            <div class="col-md-8 mt-2 mb-3">
                                            <select class="js-example-basic-multiple form-control form-control-sm my-form-control mb-3" name="simillar_porduct[]" multiple="multiple">
                                            ...
                                            <div class="col-md-4 mt-2">
                                                <strong><label>Similar Discount</label> <span
                                                        class="my-label">:</span> </strong>
                                            </div>

                                            <div class="col-md-8 mt-2 mb-3">
                                                <input type="number" name="similar_discount"  max="99"
                                                value="{{ old('similar_discount') }}" 
                                                class="form-control my-form-control @error('similar_discount') is-invalid @enderror" placeholder="Similar Discount">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 mt-1">
                                                <div class="input-group input-group-sm">
                                                    <select name="another_category_id" id="another_category_id"
                                                        ...
                                                        data-live-search="true">
                                                        <option data-tokens="ketchup mustard" value="">--Select Another Category--</option>
                                                    </select>
                                                    <div class="input-group-append">
                                                        <a class="border rounded my-select my-form-control py-0 px-2"
                                            ...
                                            <div class="col-md-4">
                                                <strong><label>Brand<span class="color-red">*</span></label><span class="my-label">:</span>
                                                </strong>
                                            </div>
                                            <div class="col-md-8 mt-1">
                                                <div class="input-group input-group-sm">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group input-group-sm mt-2">
                                                    @foreach ($size as $item)
                                                        <input type="checkbox" class="m-1 @error('size_id') is-invalid @enderror"
                                                            id="size_{{ $item->id }}" name="size_id[]"
                                                            value="{{ $item->id }}">
                                                        <label for="size_{{ $item->id }}"> {{ $item->name }}</label>
                                                    @endforeach
                                                    <div class="input-group-append">
                                                        <a class="border rounded my-select my-form-control py-0 px-2"
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-group input-group-sm mt-2">
                                                    @foreach ($color as $item)
                                                        <input type="checkbox" class="m-1 @error('color_id') is-invalid @enderror"
                                            ...
                                            <div class="col-md-8 mt-1">
                                                <input type="checkbox" value="1"
                                                    ...
                                                    {{ old('is_deal') == '1' ? 'checked' : '' }} name="is_deal"
                                                    class="" id="">
...
@push('admin-js')
    ...
    <script>
        ...
        document.getElementById("previewImage3").src = "/noimage.png";
    </script>
    <script>
        // multiple image
        $(document).ready(function() {
    ...
    <script>
        ...
        data = data + '<div class="">';
        data = data +
            '<textarea name="features[]" class="feature-input-field form-control" id="" cols="30" rows="2"></textarea>';
        data = data + '</div>';
        data = data + '</div>';
