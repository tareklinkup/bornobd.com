        ...
        <div class="container ">
            <div class="heading-title p-2 my-2">
                <span class="my-3 heading "><i class="fas fa-home"></i> <a class=""
                        href="{{ route('admin.index') }}">Home</a> >Order Tracker</span>
            </div>
                        ...
                        <div class="card-body table-card-body p-3 mytable-body">
                            <form action="{{ route('tracking.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="details"  class="form-control my-form-control  @error('details') is-invalid @enderror" id="" cols="30" rows="2"></textarea>
                                        @error('details')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <form id="delete-form-{{ $item->id }}"
                                                            action="{{ route('tracking.destroy', $item) }}" method="POST"
                                                            style="display: none;">
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
