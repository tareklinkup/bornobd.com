                ...
                <div class="row">
                     <div class="col-md-6">
                         <div class="row">
                            ...
                            <div class="col-md-8">
                                 <input type="text" name="name" class="form-control my-form-control @error('name') is-invalid @enderror" value="{{old('name')}}">
                                 @error('name')
                            ...
                            <div class="col-md-1 text-right">
                             ...
                             <div class="col-md-8">
                                <input type="number" name="rank" class="form-control my-form-control  @error('rank') is-invalid @enderror"  >
                                @error('rank')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span> 
                            ...
                            <div class="col-md-1 text-right">
                             ...
                             <div class="col-md-8">
                                <textarea name="description"class="form-control my-form-control  @error('description') is-invalid @enderror" id="editor"></textarea>
                     ...
                     <div class="col-md-6">
                        <div class="row right-row">
                            ...
                            <div class="col-md-1 text-right">
                             ...
                             <div class="col-md-8">
                                <input type="text" name="designation" class="form-control my-form-control  @error('designation') is-invalid @enderror" value="{{old('designation')}}" >
                                @error('designation')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span> 
                            ...
                            <div class="col-md-1 text-right">
                             ...
                             <div class="col-md-8">
                                <input type="text" name="department" class="form-control my-form-control  @error('department') is-invalid @enderror" value="{{old('department')}}" >
                                @error('department')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span> 
                             ...
                             <div class="col-md-3">
                                <label>Image </label><small>(size:464*580px)</small>
                            </div>
